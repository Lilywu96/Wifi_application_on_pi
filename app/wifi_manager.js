            ...
            async.series([
                ...
                function update_interfaces(next_step) {
                    write_template_to_file(
                        "./assets/etc/network/interfaces.ap.template", //TODO: what is the template
                ...
                function update_dhcpd(next_step) {
                    ...
                    write_template_to_file(
                        "./assets/etc/dhcp/dhcpd.conf.template",     //Todo!!
                        "/etc/dhcp/dhcpd.conf",
                        context, next_step);
                },
                ...
                function restart_dhcp_service(next_step) {
                    exec("sudo service udhcp restart", function(error, stdout, stderr) {
                        //console.log(stdout);
                        if (!error) console.log("... udhcp server restarted!");
                        next_step();
                    });
                },
